    ...
    <mu-flexbox class="infopage"
            ...
            <div class="content">
                ...
                <mu-flexbox class="information">
                    ...
                    <mu-flexbox class="userinfo">
                        <div class="avatar">
                            <img :src="info.infoData.owner.avatar_url"
                                 alt="">
                        </div>
                        <p class="username">{{info.infoData.owner.username}}</p>
                    </mu-flexbox>
                    <!--time-->
                    <mu-flexbox-item class="time">
                        {{info.infoData.createdAt | filterTime}}
                    </mu-flexbox-item>
                </mu-flexbox>
        ...
        <mu-appbar>
            ...
            <div class="btn-reply"
                ...
                <div class="reply-count" v-show="info.infoData.comment_count > 0">{{info.infoData.comment_count}}</div>
            </div>
            ...
            <mu-icon-button icon="star_border"
                            iconClass="collect"
                            slot="right"
                            v-show="!info.infoData.is_collected"
                            key="collect"
    ...
    methods: {
        ...
        tapToToggleCollect () {
            ...
            // 已登录
                ...
                if (!this.info.infoData.is_collected) {
                    this.$store.dispatch('collectTopic', {
                        topicid, username
                    })
                }
                else if (this.info.infoData.is_collected) {
