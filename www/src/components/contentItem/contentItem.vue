    ...
    <div class="content-item">
        ...
        <div class="complete"
            ...
            <div class="top-box">
                ...
                <div class="avatar"
                     :data-id="list._id"
                     :data-userid="list.owner._id"
                     :data-username="list.owner.username"
                     @click="tapToUserInfo($event)">
                    <img :src="list.owner.avatar_url"
                         alt="">
                </div>
                <!--info-->
                <div class="info"
        ...
        <mu-flexbox class="simple"
            ...
            <div class="info"
                ...
                <mu-flexbox class="userinfo">
                    <div class="username">{{list.owner.username}}</div>
                    <div class="time">{{list.createdAt | filterTime}}</div>
                </mu-flexbox>
            </div>
        </mu-flexbox>
        <!--simple template-->
