...
// news
export const FETCH_NEWS_SUC = 'FETCH_NEWS_SUC'
export const FETCH_NEWS_ERR = 'FETCH_NEWS_ERR'
export const FETCH_NEWS_REQ = 'FETCH_NEWS_REQ'

// user
export const COMMIT_USER_TOPIC = 'COMMIT_USER_TOPIC'
...
/*********** Getters ***********/
// login
export const COLLECT_TOPICS_COUNT = 'COLLECT_TOPICS_COUNT'
export const REPLIES_COUNT = 'REPLIES_COUNT'
export const MY_TOPICS_COUNT = 'MY_TOPICS_COUNT'
export const POST_TOPICS_COUNT = 'POST_TOPICS_COUNT'
// message
