<template>
    <div class="table">
        ...
        <el-table :data="data" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="tab" label="分类" width="120">
            </el-table-column>
        ...
        <div class="pagination">
            <el-pagination @current-change="handleCurrentChange" layout="prev, pager, next" :total="post_size">
            </el-pagination>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        getData() {
            let self = this;
            let url = '/topic?page=' + self.cur_page + '&limit=10';
        ...
        handleDelete(index, row) {
            ...
            self.$confirm('确认删除？')
                .then(_ => {
                    self.$axios.delete('topic/' + row._id).then((res) => {
                        if (res.data.code == 1) {
